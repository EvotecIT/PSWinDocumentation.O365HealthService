Import-Module "C:\Support\GitHub\PSPublishModule\PSPublishModule.psm1"

$Configuration = @{
    Information = @{
        ModuleName        = 'PSWinDocumentation.O365HealthService'
        ...
        Manifest          = @{
            ...
            RequiredModules      = @(
                ...
                @{ ModuleName = 'Graphimo'; ModuleVersion = "Latest"; Guid = '48605140-a2a9-44f3-b682-3efc5cc9f2c1' }
            )
        }
    }
    Options     = @{
        Merge             = @{
            ...
            Integrate      = @{
                ApprovedModules = @('PSSharedGoods', 'PSWriteColor', 'Connectimo', 'PSUnifi', 'PSWebToolbox', 'PSMyPassword', 'Graphimo')
            }
        }
        Standard          = @{
            FormatCodePSM1 = @{
